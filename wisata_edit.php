                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control numeric"
                                                    ...
                                                    <?php echo $wisata_row['harga_weekend_dewasa'] ?> placeholder="10000">
                                            </div>
                                            <div class="form-group">
                                                <label for="alamat">Jam Buka Hari Biasa</label>
                                                <input type="text" class="form-control timepicker"
                                                    id="jam_buka_weekday" name="jam_buka_hari_biasa" 
                                                    value="<?php echo $wisata_row['jam_buka_weekday'] ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="alamat">Jam Tutup Hari Biasa</label>
                                                <input type="text" class="form-control timepicker"
                                                    id="jam_tutup_weekday" name="jam_tutup_hari_biasa" 
                                                    value="<?php echo $wisata_row['jam_tutup_weekday'] ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="alamat">Jam Buka Akhir Pekan (sabtu-minggu)</label>
                                                <input type="text" class="form-control timepicker"
                                                    id="jam_buka_weekend" name="jam_buka_hari_weekend" 
                                                    value="<?php echo $wisata_row['jam_buka_weekend'] ?>" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label for="alamat">Jam Tutup Akhir Pekan (sabtu-minggu)</label>
                                                <input type="text" class="form-control timepicker"
                                                    id="jam_tutup_weekend" name="jam_tutup_hari_weekend" 
                                                    value="<?php echo $wisata_row['jam_buka_weekend'] ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
